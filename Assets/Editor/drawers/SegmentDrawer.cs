...
namespace Editor.Drawers
{
    public class SegmentDrawer : BaseEditorDrawer
    {
        ...
        private void UpdateSelectedSegments()
        {
            ...
            {
                if (m_cursorInfo.SelectedVertices.Contains(s.Vertex1) &&
                    m_cursorInfo.SelectedVertices.Contains(s.Vertex2))
        ...
        private bool DragTest(Segment s)
        {
            ...
            foreach (Vertex v in m_connectedVertices)
            {
                ...
                if (s.Vertex1.ScreenPosition == m_mouseSnappedPos || s.Vertex2.ScreenPosition == m_mouseSnappedPos)
                    return true;
                //intersection found
                if (Geom2D.DoIntersect(s.Vertex1.ScreenPosition, s.Vertex2.ScreenPosition, v.ScreenPosition,
                        m_mouseSnappedPos))
                    return true;
            }
